Shader "Art_URP/FunctionTest/Gear"
{
    Properties
    {
        _Num("Num" , float) = 2
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings i) : SV_Target
            {
                ...
                half v1 = smoothstep(-0.5 , 1.0 , cos(a * 10)) * 0.2 + 0.5;     //速度线效果
                half v2 = Circle(float2(0.5,0.5) , 0.2 , i.uv);
                half v3 = 1 - Circle(float2(0.5,0.5),0.1 , i.uv);
                
                FinalColor = step(v1,r) + v2 * v3;
