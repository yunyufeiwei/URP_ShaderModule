...
Shader "Moon/Demo/Par_Distortion" {
Properties {
...
half4 frag( v2f i ) : COLOR
{
	...
	i.uvgrab.x += ((offsetColor1.r + offsetColor2.r) - 1) * _HeatForce * i.vcolor.a;
	i.uvgrab.y += ((offsetColor1.g + offsetColor2.g) - 1) * _HeatForce * i.vcolor.a;
