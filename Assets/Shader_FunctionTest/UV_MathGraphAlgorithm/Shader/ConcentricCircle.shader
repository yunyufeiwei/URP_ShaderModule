Shader "Art_URP/FunctionTest/ConcentricCircle"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings i) : SV_Target
            {
                ...
                half centerDistance = distance(i.uv , _Center.xy);
                centerDistance = frac(centerDistance * _Num);
                centerDistance = step(0.2 , centerDistance);

                FinalColor = centerDistance.rrrr;
